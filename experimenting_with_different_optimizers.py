...
data = pd.read_csv('C:\\Users\\Kevin\\Desktop\\python cookbook\\data\\winequality-red.csv', sep=';')
y = data['quality']
...
def create_callbacks(opt):
    ...
    ModelCheckpoint('C:\\Users\\Kevin\\Desktop\\python cookbook\\checkpoints\\optimizers_best_' + opt + '.h5', monitor='val_acc', save_best_only=True, verbose=0)
    ]
    return callbacks
...
for opt in opts:
    ...
    best_model.load_weights('C:\\Users\\Kevin\\Desktop\\python cookbook\\checkpoints\\optimizers_best_' + opt + '.h5')
